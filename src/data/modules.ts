...
export const modules: Module[] = [
  {
    ...
    description:
      "Learn the core sorting algorithms from simple swaps to divide-and-conquer methods.",
    level: "beginner",
    algos: [
      {
        id: "bubble",
  ...
  },
  {
    ...
    title: "Arrays",
    description:
      "Learn how arrays work through simple search, update, and traversal algorithms.",
    level: "beginner",
    algos: [
      {
        id: "linear-search",
  ...
  },
  {
    id: "m-linked-lists",
    title: "Linked Lists",
    description: "Work with pointers, traversal, and in-place edits.",
    level: "intermediate",
    algos: [
      {
        id: "singly-impl",
