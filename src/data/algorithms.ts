...
export const algorithms: Record<string, AlgorithmMeta> = {
  ...
  bfs: {
    ...
    category: "Graph",
    description:
      "Breadth-First Search explores the graph level by level, starting from a source node and visiting all its neighbors before moving to the next level.",
    shortDescription: "Traverses a graph level by level using a queue.",
    complexities: {
      best: "O(V + E)",
      average: "O(V + E)",
      worst: "O(V + E)",
    ...
    tags: ["traversal", "queue", "unweighted", "shortest path"],
    href: "/learn/graphs?algorithm=bfs",
    difficulty: "beginner",
    effort: "low",
  },
  dfs: {
    ...
    category: "Graph",
    description:
      "Depth-First Search explores as far as possible along a branch before backtracking, making it ideal for exploring connectivity and components.",
    shortDescription: "Traverses a graph by going deep before backtracking.",
    complexities: {
      best: "O(V + E)",
      average: "O(V + E)",
      worst: "O(V + E)",
    ...
    href: "/learn/graphs?algorithm=dfs",
    difficulty: "beginner",
    effort: "low",
  },
  "topological-sort": {
    ...
    category: "Graph",
    description:
      "Topological Sort orders the vertices of a Directed Acyclic Graph (DAG) so that for every directed edge u → v, u comes before v in the ordering.",
    shortDescription: "Linear ordering of DAG nodes respecting dependencies.",
    complexities: {
      best: "O(V + E)",
      average: "O(V + E)",
      worst: "O(V + E)",
    ...
    tags: ["DAG", "ordering", "stack"],
    href: "/learn/graphs?algorithm=topological-sort",
    difficulty: "intermediate",
    effort: "medium",
  },
  ...
  dijkstra: {
    ...
    shortDescription: "Single-source shortest path for non-negative weights.",
    complexities: {
      best: "O(E + V log V)",
      average: "O(E + V log V)",
      worst: "O(E + V log V)",
  ...
  "bellman-ford": {
    ...
    category: "Graph",
    description:
      "Bellman-Ford computes shortest paths from a single source in graphs that may contain negative weights, and can detect negative cycles.",
    shortDescription:
    ...
    tags: ["shortest path", "negative weights", "DP"],
    difficulty: "intermediate",
    effort: "medium",
  },
  ...
  "floyd-warshall": {
    ...
    category: "Graph",
    description:
      "Floyd-Warshall finds shortest paths between all pairs of nodes. It works with positive and negative edge weights (no negative cycles).",
    shortDescription: "All-pairs shortest paths using dynamic programming.",
    complexities: {
      best: "O(V^3)",
      average: "O(V^3)",
      worst: "O(V^3)",
    ...
    tags: ["all pairs", "shortest path", "DP"],
    difficulty: "advanced",
    effort: "high",
  },
  kruskal: {
    ...
    category: "Graph",
    description:
      "Kruskal's algorithm builds a Minimum Spanning Tree by adding edges in increasing order of weight, skipping those that create cycles.",
    shortDescription: "MST using sorting and union-find.",
    complexities: {
      best: "O(E log E)",
      average: "O(E log E)",
      worst: "O(E log E)",
  ...
  prim: {
    ...
    category: "Graph",
    description:
      "Prim's algorithm builds a Minimum Spanning Tree by starting at an arbitrary node and expanding the tree by choosing the smallest edge crossing the cut.",
    shortDescription: "MST using a priority queue.",
    complexities: {
      best: "O(E + V log V)",
      average: "O(E + V log V)",
      worst: "O(E + V log V)",
    ...
    pseudocode: [
      ...
      "    visited.add(start)",
      "    while pq is not empty and len(mst) < V - 1:",
      "        (w, u, v) = pq.pop()",
      "        if v not in visited:",
      "            mst.append((u, v, w))",
      "            visited.add(v)",
  ...
  "detect-cycle-directed": {
    ...
    category: "Graph",
    description:
      "Detects cycles in a directed graph using DFS and recursion stack coloring.",
    shortDescription: "Cycle detection in directed graphs using DFS.",
    complexities: {
      best: "O(V + E)",
      average: "O(V + E)",
      worst: "O(V + E)",
    ...
    tags: ["cycle detection", "DFS", "directed"],
    difficulty: "intermediate",
    effort: "low",
  },
  "detect-cycle-undirected": {
    ...
    category: "Graph",
    description:
      "Detects cycles in an undirected graph using DFS with parent tracking or union-find.",
    shortDescription:
      "Cycle detection in undirected graphs using DFS or union-find.",
    complexities: {
      best: "O(V + E)",
      average: "O(V + E)",
      worst: "O(V + E)",
    ...
    tags: ["cycle detection", "DFS", "undirected"],
    difficulty: "intermediate",
    effort: "low",
  },
};
